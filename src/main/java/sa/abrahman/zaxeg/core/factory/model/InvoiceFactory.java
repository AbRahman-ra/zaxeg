package sa.abrahman.zaxeg.core.factory.model;
...
public class InvoiceFactory {
    ...
    private InvoiceTypeTransactions mapInvoiceTypeTransactions(MetadataPayload.InvoiceTypeTransactions payload) {
        return InvoiceTypeTransactions.builder()
                .subtype(payload.getSubtype())
                .thirdParty(payload.isThirdParty())
                .nominal(payload.isNominal())
                .exports(payload.isExports())
                .summary(payload.isSummary())
                .selfBilled(payload.isSelfBilled())
                .build();
    }
