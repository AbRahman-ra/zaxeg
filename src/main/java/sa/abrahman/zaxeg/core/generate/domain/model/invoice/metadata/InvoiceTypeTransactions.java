...
public class InvoiceTypeTransactions {
    ...
    public String code() {
        ...
        return subtype.code() + toIntString.apply(thirdParty) + toIntString.apply(nominal) + toIntString.apply(exports)
                + toIntString.apply(summary) + toIntString.apply(selfBilled);
    }
}
