...
/**
 * <p>
 * Invoice Metadata, any invoice stateful information that is neither related to the items nor the amounts directlu will
 * be stored here
 * </p>
 * <p>
 * <b>Example</b>
...
public class Metadata {
    ...
    /**
     * BT-05: The currency in which all Invoice amounts are given, except for the Total VAT amount in accounting
     * currency.
     */
    @Builder.Default
    ...
    /**
     * BT-06: The currency used for VAT accounting and reporting purposes as accepted or required in the country of the
     * Seller. Shall be used in combination with the Total VAT amount in accounting currency (BT-111).
     */
    @Builder.Default
    ...
    /**
     * BG-3, BT-25: The sequential number (Invoice number BT-1) of the original invoice(s) that the credit/debit note is
     * related to.
     */
    @Nullable
     ...
     * <li>KSA-13:
     * <ul>
     * <li>The base64 encoded SHA256 hash of the previous invoice. This hash will be computed from the business payload
     * of the previous invoice: UBL XML of the previous invoice without tags for QR code (KSA-14) and cryptographic
     * stamp (KSA-15).</li>
     * <li>For the first invoice, the previous invoice hash is
     * {@code "NWZlY2ViNjZmZmM4NmYzOGQ5NTI3ODZjNmQ2OTZjNzljMmRiYzIzOWRkNGU5MWI0NjcyOWQ3M2EyN2ZiNTdlOQ=="}, the
     * equivalent for base64 encoded SHA256 of {@code "0"} (zero) character.</li>
     * </ul>
     * <p>
     ...
     * <li>QR Code stamp (For simplified tax invoices and associated notes, it will be applied by the seller's device.
     * For the tax invoice and associated notes, it will be applied by ZATCA)</li>
     * </ul>
     * <p>
     * More details can be found in the Security Features Implementation Standard.
     * </p>
    ...
    /**
     * <ul>
     * <li>KSA-10: Reasons for issuance of credit / debit note as per Article 40 (paragraph 1) and Article 54 (3) of KSA
     * VAT regulations, a Credit and Debit Note is issued for these 5 instances:</li>
     * <ul>
