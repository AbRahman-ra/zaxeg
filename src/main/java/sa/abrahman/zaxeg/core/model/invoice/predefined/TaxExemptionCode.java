...
public enum TaxExemptionCode {
    ...
    /** {@code VATEX-SA-34-3}: Services directly connected and incidental to a Supply of international passenger transport */
    ...
    /** {@code VATEX-SA-34-5}: Any services relating to Goods or passenger transportation, as defined in article twenty five of these Regulations */
