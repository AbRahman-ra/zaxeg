...
public class SimplifiedInvoiceValidator implements InvoiceValidator {
    ...
    @Override
    public void validate(InvoiceGenerationCommand invoice) {
        ...
        //             .hasLength(15, "BR-KSA-14: If provided, VAT number must be exactly 15 digits.")
        //             .startsAndEndsWith("3", "BR-KSA-14: VAT number must be starting and ending with '3'.");
        // }
    }
