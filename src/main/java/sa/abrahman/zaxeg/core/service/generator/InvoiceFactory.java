...
import sa.abrahman.zaxeg.core.model.invoice.financial.DocumentFinancials;
import sa.abrahman.zaxeg.core.model.invoice.financial.InvoiceGlobalPayable;
import sa.abrahman.zaxeg.core.model.invoice.financial.InvoiceLine;
import sa.abrahman.zaxeg.core.model.invoice.meta.BillingReference;
...
import sa.abrahman.zaxeg.core.port.in.InvoiceGenerationCommand.AddressCommand;
import sa.abrahman.zaxeg.core.port.in.InvoiceGenerationCommand.BillingReferenceCommand;
...
import sa.abrahman.zaxeg.core.port.in.InvoiceGenerationCommand.PartyCommand;
import sa.abrahman.zaxeg.core.service.processor.FinancialsCommandCalculator;

@UtilityClass
public class InvoiceFactory {
    public Invoice from(InvoiceGenerationCommand payload) {
        Function<BillingReferenceCommand, BillingReference> billingReferenceMapper = b -> BillingReference.builder()
                .originalInvoiceNumber(b.getOriginalInvoiceNumber())
                .build();

        Function<AddressCommand, Address> addressMapper = ac -> Address.builder()
        ...
        Function<PartyCommand, BusinessParty> partyMapper = c -> BusinessParty.builder()
        ...
        Function<LineCommand, InvoiceLine> lineMapper = l -> {
            BigDecimal netPrice = FinancialsCommandCalculator.getNetPrice(l.getUnitPrice(), l.getQuantity(),
                    l.getLineDiscount());
            BigDecimal taxAmount = FinancialsCommandCalculator.getTaxAmount(netPrice, l.getTaxCategory());
        ...
        Function<InvoiceGlobalPayableCommand, InvoiceGlobalPayable> allowancesAndOrChargesMapper = ac -> InvoiceGlobalPayable
                .builder()
        ...
        Function<FinancialsCommand, DocumentFinancials> financialsMapper = f -> DocumentFinancials.builder()
