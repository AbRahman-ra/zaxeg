...
import sa.abrahman.zaxeg.core.port.in.payload.PayloadCommons.TaxTotal;
...
public class CheckoutDetailsPayload {
     ...
     *
     * <p>
     * If the API caller provides these, your Math Engine will calculate the invoice
     * and then assert that its math matches the caller's math.
     * </p>
     */
