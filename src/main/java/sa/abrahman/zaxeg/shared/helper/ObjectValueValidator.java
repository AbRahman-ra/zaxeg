...
public class ObjectValueValidator<C, E extends RuntimeException> {
     ...
     */
    @Deprecated public static <C, E extends RuntimeException> ObjectValueValidator<C, E> check(C subject,
            Function<String, E> exceptionFactory) {
        return new ObjectValueValidator<>(subject, exceptionFactory);
    }

    @Deprecated public ObjectValueValidator<C, E> exists(String errMsg) {
        if (subject == null)
     ...
     * @return
     */
    @Deprecated public ObjectValueValidator<C, E> matches(Predicate<C> predicate, String errMsg) {
