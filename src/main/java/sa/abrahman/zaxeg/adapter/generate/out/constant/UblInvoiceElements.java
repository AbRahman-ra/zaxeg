package sa.abrahman.zaxeg.adapter.generate.out.constant;

import lombok.experimental.UtilityClass;

@UtilityClass
public final class UblInvoiceElements {
    ...
    public static final class TAGS {
        ...
        public static final class CBC {
            ...
            public static final String EMBEDDED_DOCUMENT_BINARY_OBJECT = "cbc:EmbeddedDocumentBinaryObject";
        }
    ...
    public static final class ATTRIBUTES {
        ...
        public static final String MIME_CODE = "mimeCode";
        ...
        public static final class XMLNS {
            ...
            public static final String EXT = "xmlns:ext";
        }
    }
}
