...
public class MetadataRequest implements Mapable<MetadataPayload, Void> {
    ...
    @Override
    public MetadataPayload mapped(Void additionalData) {
        // nullables
        ...
        return MetadataPayload.builder().invoiceNumber(this.invoiceNumber).invoiceUuid(this.invoiceUuid)
                ...
                .invoiceTypeTransactions(this.invoiceTypeTransactions.mapped())
                ...
                .billingReference(this.billingReference != null ? this.billingReference.mapped() : null)
                .purchaseOrder(this.purchaseOrder != null ? this.purchaseOrder.mapped() : null)
                .contract(this.contract != null ? this.contract.mapped() : null).build();
    }
    ...
    @Data
    @NullMarked
    private static class InvoiceTypeTransactions implements Mapable<MetadataPayload.InvoiceTypeTransactions, Void> {
        ...
        @Override
        public MetadataPayload.InvoiceTypeTransactions mapped(Void d) {
    ...
    @Data
    @NullMarked
    private static class DocumentReference implements Mapable<MetadataPayload.DocumentReference, Void> {
        @NotBlank(message = ImplicitRules.DOC_REF_ID_NOT_NULL)
        private String id;

        @Override
        public MetadataPayload.DocumentReference mapped(Void d) {
