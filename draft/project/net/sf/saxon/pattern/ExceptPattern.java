...
extends VennPattern {
    ...
    public int computeHashCode() {
        return 0x9BD7DFA6 ^ this.p1.hashCode() ^ this.p2.hashCode();
    }
    ...
    public Pattern copy(RebindingMap rebindings) {
        ExceptPattern n = new ExceptPattern(this.p1.copy(rebindings), this.p2.copy(rebindings));
