...
implements DOMImplementation {
    ...
    static {
        try {
            ...
            singleton.setSingletonClassName((class$org$dom4j$dom$DOMDocumentFactory == null ? (class$org$dom4j$dom$DOMDocumentFactory = DOMDocumentFactory.class$("org.dom4j.dom.DOMDocumentFactory")) : class$org$dom4j$dom$DOMDocumentFactory).getName());
        } catch (Exception exception) {
            // empty catch block
        }
    }
