...
implements Serializable {
    ...
    protected static DocumentFactory createSingleton(String className) {
        try {
            Class<?> theClass = Class.forName(className, true, (class$org$dom4j$DocumentFactory == null ? (class$org$dom4j$DocumentFactory = DocumentFactory.class$("org.dom4j.DocumentFactory")) : class$org$dom4j$DocumentFactory).getClassLoader());
