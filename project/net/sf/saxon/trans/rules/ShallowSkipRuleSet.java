        ...
        if (item instanceof NodeInfo) {
            ...
            switch (node.getNodeKind()) {
                case 1: {
                    ...
                    c2.setOrigin(this);
                    c2.trackFocus(node.iterateAxis(2));
                    c2.setCurrentComponent(c2.getCurrentMode());
                    for (tc = c2.getCurrentMode().getActor().applyTemplates(parameters, tunnelParams, null, output, c2, locationId); tc != null; tc = tc.processLeavingTail()) {
                    }
                }
                case 9: {
                    TailCall tc;
