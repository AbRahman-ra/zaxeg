...
Externalizable {
    ...
    public void startElement(String namespaceURI, String localName, String qualifiedName, Attributes attributes) throws SAXException {
        ...
        QName qName = null;
        qName = namespaceURI != null ? new QName(localName, Namespace.get(namespaceURI)) : new QName(localName);
        if (attributes != null && attributes.getLength() > 0) {
            ...
            for (int i = 0; i < attributes.getLength(); ++i) {
                ...
                if (attLocalName.startsWith(XMLNS)) {
                    String prefix = null;
                    prefix = attLocalName.length() > 5 ? attLocalName.substring(6) : EMPTY_STRING;
                    ...
                    ArrayList<String> prefixes = (ArrayList<String>)this.prefixMappings.get(qName);
                    if (prefixes == null) {
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        elementName = namespaceURI != null ? new QName(localName, Namespace.get(namespaceURI)) : new QName(localName);
