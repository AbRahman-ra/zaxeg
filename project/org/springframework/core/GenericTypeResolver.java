        ...
        if (type != ResolvableType.NONE) {
            ...
            if (resolved != null && type.getType() instanceof ParameterizedType) {
                ...
                for (int i = 0; i < variables.length; ++i) {
                    ...
                    while (generic2.getType() instanceof TypeVariable) {
                        generic2 = generic2.resolveType();
                    }
                    if (generic2 == ResolvableType.NONE) continue;
                    typeVariableMap.put(variables[i], generic2.getType());
                }
            }
