 ...
 */
package com.gazt.einvoicing.signing.service.utils;
...
public interface InvoiceXmlXPath {
    ...
    public static final String UBL_EXTENSIONS_SIGNATURE_CERTIFICATE = "/Invoice/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/sig:UBLDocumentSignatures/sac:SignatureInformation/ds:Signature/ds:KeyInfo/ds:X509Data/ds:X509Certificate";
