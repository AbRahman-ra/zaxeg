...
public class ApiValidationProcessorImpl
implements ValidationProcessor {
    private static final Logger LOG = Logger.getLogger(ApiValidationProcessorImpl.class);
    ...
    private void logResult(Result result, String stage) {
        LOG.info(stage + " validation result : " + (result.isValid() ? "PASSED" : "FAILED"));
        if (!result.isValid()) {
