...
public class PrivateKey {
    ...
    public ByteString toDer() {
        ...
        return Der.encodeSequence(Der.encodeInteger(BigInteger.valueOf(1L)), Der.encodeOctetString(this.toByteString()), Der.encodeConstructed(0L, Der.encodeOid(this.curve.oid)), Der.encodeConstructed(1L, Der.encodeBitString(encodedPublicKey)));
    }
    ...
    public static PrivateKey fromDer(String string) {
        return PrivateKey.fromDer(new ByteString(string.getBytes()));
    }
    ...
    public static PrivateKey fromString(String string) {
        return PrivateKey.fromString(new ByteString(string.getBytes()));
    }
